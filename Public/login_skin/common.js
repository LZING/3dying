...
function Dmsg(str, i, s, t) {
	...
	try{if(s){window.scrollTo(0,0);}Dd('d'+i).innerHTML = '<img src="/biz_admin/skin/images/check_error.gif" width="12" height="12" align="absmiddle"/> '+str+sound('tip');Dd(i).focus();}catch(e){}
