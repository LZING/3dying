...
var draw_graph = function(graphType,obj){
    ...
    var mousedown = function(e){
        ...
        if (e.touches !== undefined && e.touches.length == 1 ) {
            ...
            startX = e.clientX ? e.clientX : e.originalEvent.changedTouches[0].clientX;
            startY = e.clientX ? e.clientY : e.originalEvent.changedTouches[0].clientY;
        }
    ...
    var mouseup = function(e){
        ...
        if(graphType!='rubber'){
            ...
            // 遗留的小尾巴
            // var x = e.clientX ? e.clientX : e.originalEvent.changedTouches[0].clientX   - canvasLeft;
            // var y = e.clientX ? e.clientY : e.originalEvent.changedTouches[0].clientY  - canvasTop;
            // context.beginPath();
            // context.moveTo(x ,y );
    ...
    var  mousemove = function(e){
        ...
        if (e.touches !== undefined && e.touches.length == 1 ) {
            ...
            x = e.clientX ? e.clientX : e.originalEvent.changedTouches[0].clientX;
            y = e.clientX ? e.clientY : e.originalEvent.changedTouches[0].clientY;
        }
        x = x - canvasLeft;
        y = y - canvasTop;
    ...
    $(canvas_bak).bind('click',function() {});
}
