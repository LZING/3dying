...
LITHO.Lithophane = function() {
    ...
    ,this.onlineSaveAndPrint = document.getElementById("onlineSaveAndPrint")
...
LITHO.Lithophane.prototype = {
    ...
    setupDragNDrop: function() {
        var e = this;
        this.previewFile(),
        this.fileUpload.onchange = function(t) {
        ...
        this.onlineSaveAndPrint.onclick = function(t) {
            ...
            xhr.onload = function(ev) {
            	if (this.status == 200 && this.responseText>0) {
            	    ...
            	    //a.setAttribute("href", "http://www.dayin.la/apps/print.html#" + this.responseText);
 ...
 */
    ...
    createHeightMesh: function(e) {
        ...
        function c() {
            ...
            m.actionBtn.style.display = "block";
        }
        var l, d, p, g, m = this,
...
LITHO.Scene3D.prototype = {
    ...
    setUp3DScene: function(lithoMesh,vertexPixelRatio, bool) {
        try {
            ...
            helper.setColors(new THREE.Color(0xDDDDDD), new THREE.Color(0xDDDDDD));
