        ...
        <div id="panel_main_inner">
            ...
            <div id="panel_info" data-intro="" data-step="1" data-position="right" class="">
                <div class="panel_one_info"><div class="label_info">*模型名</div>
                    <input class="edit_text" id="edit_name" name="title" maxlength="25">
                ...
                <div class="panel_one_info">
                    <div class="label_info">下载权限</div>
                     <select class="edit_text" name="private" id="select_privacy">
                        <option value="1">对所有人</option>
                        <option value="2">vip</option>
                        <option value="3">仅对我自己</option>
                    </select>
                </div>
                ...
                <div class="panel_one_info">
                    ...
                    <textarea name="intro" class="edit_text" id="textarea_introduce" maxlength="140" style="outline: none;"></textarea>
                </div>
            </div>
...
window.onload = function() {
    var settings1 = {
        ...
        upload_url: "/swf?uid=<?php echo $this->user['id']; ?>&type=file&dir=<?php echo date('H') . rand(1, 10000);?>",
