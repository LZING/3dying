		...
		<TR class=firstalt>
          ...
          <TD noWrap align=middle>
           ...
           <?php if($value['forbid'] == 0 ){?>
               ...
               <?php }?>
              丨 <a href="/admin/index/repwd/?uid=<?php echo $value['id']?>">改密</a>
              丨 
