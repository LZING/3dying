      ...
      <td>
         <table width="100%" cellpadding="0" cellspacing="1" border="0">
                      <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
                        <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="/SJZws/index/image" target="content">首页播放图片</a>
                        </td>
                     </tr>
                     <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
                        <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="/SJZws/index/imagelist" target="content">图片列表</a>
                        </td>
                     </tr>
  ...
  <tr id="nav_tr_4" >
     <td>
         <table width="100%" cellpadding="0" cellspacing="1" border="0">
                     <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
                        <td>
                        &nbsp;&nbsp;&nbsp;&nbsp;<a href="/SJZws/index/user/" target="content">会员列表</a>                        
                        </td>
                     </tr>
  ...
  <tr id="nav_tr_3" >
    <td>
        <table width="100%" cellpadding="0" cellspacing="1" border="0">
            ...
            <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
              <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/SJZws/index/atta/" target="content">模型列表</a> </td>
            </tr>
            <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
...
<!--           <table width="100%" cellpadding="0" cellspacing="1" border="0"> 
              <tr class="firstalt" onmouseover="this.className='secondalt'" onmouseout="this.className='firstalt'">
<!--                   <td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" target="content">关于我们</a> </td> -->
<!--               </tr> -->
<!--           </table> -->
<!--       </td> -->
<!--   </tr> -->
