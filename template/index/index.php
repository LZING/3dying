<?php $this->load('Public/header.php');?>
  ...
  <div id="float_left1" ><!--固定左边分类开始-->
    <div class="float-title">3D模型分类</div>
    <ul class="float-fl">
      <li style="background:#ba9a4f;"><a style="color:#FFF;" href="/list">全部模型</a></li>
      <li><a target="_blank" href="/list/?type=1">推荐模型</a></li>
      <li><a target="_blank" href="/list/?type=7">人物模型</a></li>
      <li><a target="_blank" href="/list/?type=8">动物模型</a></li>
      <li><a target="_blank" href="/list/?type=9">创意模型</a></li>
      <li><a target="_blank" href="/list/?type=10">数码模型</a></li>
      <li><a target="_blank" href="/list/?type=11">游戏模型</a></li>
      <li><a target="_blank" href="/list/?type=12">工具模型</a></li>
      <li><a target="_blank" href="/list/?type=13">建筑模型</a></li>
      <li><a target="_blank" href="/list/?type=15">汽车模型</a></li>
	  <li><a target="_blank" href="/list/?type=17">巧克力模型</a></li>
      <li><a target="_blank" href="/list/?type=16">其他模型</a></li>
    </ul>
  </div><!--固定左边分类结束--> 
    <div class="clear"></div>
...
<div class="fenlei"><!--fenlei开始-->
    ...
    <div class="fenleis"><!--fenleis开始-->
        ...
        <div class="fenleis-one">
            ...
            <div class="tp"><a target="_blank" href="/list?type=1"><img alt="威森3D推荐模型" src="/Public/images/1.gif" /></a></div>

            <div class="tp"><a target="_blank" href="/list?type=9"><img alt="威森3D创意模型" src="/Public/images/2.gif" /></a></div>

            <div class="tp"><a target="_blank" href="/list?type=7"><img alt="威森3D人物模型" src="/Public/images/3.gif" /></a></div>
        ...
        <div class="fenlei-one">
            ...
            <div class="tp"><a target="_blank" href="/list?type=12"><img alt="3D工具模型" src="/Public/images/4.gif" /></a></div>

            <div class="tp"><a target="_blank" href="/list?type=8"><img alt="3D动物模型" src="/Public/images/5.gif" /></a></div>

            <div class="tp"><a target="_blank" href="/list?type=13"><img alt="3D建筑模型" src="/Public/images/6.gif" /></a></div>
    ...
    <div class="one"><!--one第一行开始-->
        ...
        <div class="special"><!--个性图片开始-->
            ...
            <div class="special-pic">
                ...
                <div style="float:left;"><a target="_blank" title="3D数码模型" href="/list?type=10"><img src="/Public/images/gx1.jpg" /></a></div>

                <div style="float:left;"><a target="_blank" title="3D创意模型" href="/list?type=9"><img src="/Public/images/gx2.jpg" /></a></div>

                <div style="float:left;"><a target="_blank" title="游戏类3D模型" href="/list?type=11"><img src="/Public/images/gx3.jpg" /></a></div>

                <div style="float:left;"><a target="_blank" title="3D工具模型" href="/list?type=12"><img src="/Public/images/gx4.jpg" /></a></div>

                <div style="float:left;"><a target="_blank" title="3D建筑模型" href="/list?type=13"><img src="/Public/images/gx5.jpg" /></a></div>
        ...
        <div class="title-one">
            ...
            <div class="wx"><a target="_blank" href="http://weibo.com/5110073943/profile?topnav=1&wvr=5&from=company&user=1&sudaref=www.weisen3d.com"><img alt="公司微信" src="/Public/images/wx.jpg" /></a></div>
        ...
        <div class="chanpin"><!--chanpin开始-->
            ...
            <div class="cp-one"><!--cp-one开始-->
                ...
                <div class="cp-pic"><a target="_blank" href="/list/index/detail/?id=<?php echo $value['id'];?>"><img src="<?php echo $value['thumb'];?>" /></a></div>

                <div class="clear"></div>

                <div class="cp-title">

                    <h1><a target="_blank" href="/list/index/detail/?id=<?php echo $value['id'];?>"><?php echo mb_substr($value['title'],0,10,'utf-8');?></a></h1>
        ...
        <div class="more">
            ...
            <h2><a target="_blank" href="/list/?type=1">查看更多</a></h2>
        ...
        <div class="more">
            ...
            <h2><a target="_blank" href="/list/?type=9">查看更多</a></h2>
        ...
        <div class="more">
            ...
            <h2><a target="_blank" href="/list/?type=7">查看更多</a></h2>
